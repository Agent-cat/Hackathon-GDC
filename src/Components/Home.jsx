...
const Home = () => {
  ...
  return (
    <div ref={containerRef} className="relative h-screen overflow-hidden">
      ...
      {/* Existing content */}
      <div className="container gap-40 mt-32 mx-auto px-6 py-6 flex flex-col md:flex-row justify-center items-center relative z-10">
        <div className="relative">
          <img className="donate-image scale-125" src={img2} alt="Donate" />
          <svg
